        ...
        <div className='grid md:grid-cols-3 gap-8 px-4 md:px-0'>
           ...
           <div className='space-y-6'>
              <div className='bg-muted/20 p-6 rounded-xl border border-red-950/40'>
                 ...
                 <Link href={`/register/${slug}`} className='block w-full text-center bg-white text-black py-2.5 rounded-lg font-bold text-base mt-6 hover:bg-red-600 hover:text-white transition-all shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(220,38,38,0.5)] zen-dots-regular uppercase'>
                    Register Now
                 </Link>
              </div>
           </div>
