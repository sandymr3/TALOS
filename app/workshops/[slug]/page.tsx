              ...
              <CardItem translateZ='80' className='mt-4 pt-4 border-t border-white/10 w-full'>
                <div className='flex flex-wrap gap-6 md:gap-12 text-white/90 font-ibm-plex-mono'>
                  <div className='flex flex-col'>
                    ...
                    <span className='text-xs md:text-sm font-bold'>FEB 15, 2025</span>
                  </div>
                  <div className='flex flex-col'>
                    <span className='text-[10px] uppercase tracking-[0.2em] text-red-500 font-bold mb-1'>Duration</span>
                    <span className='text-xs md:text-sm font-bold'>4 HOURS</span>
                  </div>
                  <div className='flex flex-col'>
                    <span className='text-[10px] uppercase tracking-[0.2em] text-red-500 font-bold mb-1'>Instructor</span>
                    <span className='text-xs md:text-sm font-bold uppercase'>DR. EXPERT</span>
                  </div>
                </div>
              </CardItem>
            </div>
        ...
        <div className='grid md:grid-cols-3 gap-8 px-4 md:px-0'>
           <div className='md:col-span-2 space-y-8'>
              <div className='prose prose-invert max-w-none pb-8 border-b border-red-950/40'>
                 <h3 className='text-2xl md:text-3xl font-bold font-zen-dots text-[#dc2626] mb-4'>Overview</h3>
              ...
              <div className='bg-muted/20 p-6 rounded-xl border border-red-950/40'>
                 <h3 className='text-2xl md:text-3xl font-bold font-zen-dots text-[#dc2626] mb-4'>Curriculum</h3>
                 <p className='text-gray-300 ibm-plex-mono-semibold text-base md:text-lg font-bold'>
           ...
           <div className='space-y-6'>
              <div className='bg-muted/20 p-6 rounded-xl border border-red-950/40'>
                 <h4 className='text-lg font-bold font-zen-dots text-[#dc2626] mb-4'>Workshop Info</h4>
